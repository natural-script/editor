...
Blockly.Msg = {
    "@metadata": {
        ...
        "lastupdated": "2020-06-25 16:02:02.440339",
        "locale": "en",
    ...
    "CONTROLS_FOREACH_INPUT_DO": Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"],
    "CONTROLS_FOR_INPUT_DO": Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"],
    "CONTROLS_IF_ELSEIF_TITLE_ELSEIF": Blockly.Msg["CONTROLS_IF_MSG_ELSEIF"],
    "CONTROLS_IF_ELSE_TITLE_ELSE": Blockly.Msg["CONTROLS_IF_MSG_ELSE"],
    "CONTROLS_IF_IF_TITLE_IF": Blockly.Msg["CONTROLS_IF_MSG_IF"],
    "CONTROLS_IF_MSG_THEN": Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"],
    "CONTROLS_WHILEUNTIL_INPUT_DO": Blockly.Msg["CONTROLS_REPEAT_INPUT_DO"],
    "LISTS_CREATE_WITH_ITEM_TITLE": Blockly.Msg["VARIABLES_DEFAULT_NAME"],
    "LISTS_GET_INDEX_HELPURL": Blockly.Msg["LISTS_INDEX_OF_HELPURL"],
    "LISTS_GET_INDEX_INPUT_IN_LIST": Blockly.Msg["LISTS_INLIST"],
    "LISTS_GET_SUBLIST_INPUT_IN_LIST": Blockly.Msg["LISTS_INLIST"],
    "LISTS_INDEX_OF_INPUT_IN_LIST": Blockly.Msg["LISTS_INLIST"],
    "LISTS_SET_INDEX_INPUT_IN_LIST": Blockly.Msg["LISTS_INLIST"],
    "MATH_CHANGE_TITLE_ITEM": Blockly.Msg["VARIABLES_DEFAULT_NAME"],
    "PROCEDURES_DEFRETURN_COMMENT": Blockly.Msg["PROCEDURES_DEFNORETURN_COMMENT"],
    "PROCEDURES_DEFRETURN_DO": Blockly.Msg["PROCEDURES_DEFNORETURN_DO"],
    "PROCEDURES_DEFRETURN_PROCEDURE": Blockly.Msg["PROCEDURES_DEFNORETURN_PROCEDURE"],
    "PROCEDURES_DEFRETURN_TITLE": Blockly.Msg["PROCEDURES_DEFNORETURN_TITLE"],
    "TEXT_APPEND_VARIABLE": Blockly.Msg["VARIABLES_DEFAULT_NAME"],
    "TEXT_CREATE_JOIN_ITEM_TITLE_ITEM": Blockly.Msg["VARIABLES_DEFAULT_NAME"],
    "MATH_HUE": "230",
    "LOOPS_HUE": "120",
    "LISTS_HUE": "260",
    "LOGIC_HUE": "210",
